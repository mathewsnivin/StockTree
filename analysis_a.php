...
function insertIntoResultTable($companyTicker, $nextDayIncrease, $nextDayIncreasePercent, $averageIncreasePercentage, $nextDayDecrease, $nextDayDecreasePercent, $averageDecreasePercentage){
	...
	$stockTreesBuyValue = $nextDayIncreasePercent * $averageIncreasePercentage;
	$stockTreesSellValue = $nextDayDecreasePercent * $averageDecreasePercentage;
	...
	if($numberOfRows==1){
		$sql = "UPDATE analysisa SET ticker='$companyTicker',daysInc='$nextDayIncrease',pctOfDaysInc='$nextDayIncreasePercent',avgIncPct='$averageIncreasePercentage',daysDec='$nextDayDecrease',pctOfDaysDec='$nextDayDecreasePercent',avgDecPct='$averageDecreasePercentage',stockTreesBuyValue='$stockTreesBuyValue',stockTreesSellValue='$stockTreesSellValue' WHERE ticker='$companyTicker' ";
		mysql_query($sql);
	}else{
		$sql="INSERT INTO analysisa (ticker,daysInc,pctOfDaysInc,avgIncPct,daysDec,pctOfDaysDec,avgDecPct,stockTreesBuyValue,stockTreesSellValue) VALUES ('$companyTicker', '$nextDayIncrease', '$nextDayIncreasePercent', '$averageIncreasePercentage', '$nextDayDecrease', '$nextDayDecreasePercent', '$averageDecreasePercentage', '$stockTreesBuyValue', '$stockTreesSellValue')";
		mysql_query($sql);
	}
}
