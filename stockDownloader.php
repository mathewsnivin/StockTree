...
function createURL($ticker) {
	...
	$currentDay = date("j");
	$currentYear = date("Y");
    $yearfv = $currentYear-5;	
	return "https://ichart.finance.yahoo.com/table.csv?s=$ticker&a=$currentMonth&b=$currentDay&c=$yearfv&d=$currentMonth&e=$currentDay&f=$currentYear&g=d&ignore=.csv";
}
